...
SECRET_KEY = 'django-insecure-0j&0%@4so=1(r+gt5*o%lho35t-gjn6fbhn25u9qgn9!5rhgx('
...
LOGIN_REDIRECT_URL = "/"   # sau khi login sẽ redirect về trang này
LOGOUT_REDIRECT_URL = "/"  # logout xong redirect về
